    ...
    <div class="min-h-screen bg-gray-100 pb-6">
      <AuthenticatedLayout>
        ...
        <div class="md:mx-auto mx-5 max-w-screen-2xl sm:px-6 lg:px-8 pt-12 ">
          <div class="bg-white rounded-lg shadow grid grid-cols-5 min-h-[45rem] mb-8  md:auto-rows-auto auto-rows-max">
            <div
            ...
            <div class="col-span-5 md:col-span-4 p-2">
              <Persons v-if="currentPage === 'persons'"></Persons>
              <Credits v-if="currentPage === 'credits'"></Credits>
            </div>
          </div>
        </div>
      </AuthenticatedLayout>
...
import Persons from "./Persons/Main.vue"
import Credits from "./Credits/Main.vue"
import auth from "@/auth.js";
export default defineComponent({
  components: {AuthenticatedLayout, PrimaryButton, Head, Link, Persons , Credits},
  data() {
    return {
      currentPage: "persons",
      showingNavigationDropdown: false,
      pages: [
        {link: 'persons', name: 'کارمندان'},
        {link: 'credits', name: 'اعتبارات'},
      ]
    }
  },
  created() {

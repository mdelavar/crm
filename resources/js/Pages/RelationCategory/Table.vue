<template>
    <div class="relative intro-y">
        <div class="flex justify-between mb-3 items-center md:flex-row flex-col">
            <span class="text-2xl mb-3 md:mb-0">فهرست دسته بندی ارتباطات</span>
            <PrimaryButton v-if="hasPermission('r_category_create')" @click="clearForm">
                ...
                <tr v-for="(item, index) in categories.data" class="even:bg-gray-50">
                    ...
                    <td class="p-2 border">
                        <div class="flex items-center">
                            <div v-if="hasPermission('r_category_edit')">
                                <a

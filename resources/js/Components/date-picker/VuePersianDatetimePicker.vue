<template>
  ...
  >
    ...
    >
      ...
      >
        <slot name="label">
          <TimeIcon v-if="type === 'time'" width="16px" height="16px"/>
          <CalendarIcon v-else width="16px" height="16px"/>
    ...
    computed: {
        ...
        months() {
            if (this.hasStep("m")) {
                ...
                const months = this.core.getMonthsList(
                    this.minDate,
                    this.maxDate,
                    date
                );
    ...
    methods: {
        ...
        setTimezone(date, mode) {
            ...
            if (tz) {
                ...
                const moment = this.core.moment;
                if (typeof tz === "string") {
                    const t = moment().utc().format("YYYY-MM-DDTHH:mm:ss") + tz;
